...
function renderForm($id, $title, $price, $error)
...
<input type="submit" name="submit"  value="Cancel" class="btn btn-primary" onclick="window.location='orders.php'">
...
renderForm($id, $title, $price, $error);
...
mysql_query("UPDATE orders SET title='$title', price='$price' WHERE id='$id'")
